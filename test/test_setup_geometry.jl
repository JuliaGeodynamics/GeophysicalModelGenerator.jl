...
# inclined lithosphere; UpperCrust,LowerCrust,Mantle
...
# inclined lithosphere with respect to the default origin; UpperCrust,LowerCrust,Mantle
Temp    =   zeros(Float64, Grid.N...);
Phases  =   zeros(Int64,  Grid.N...);
...
@test sum(Temp[1,1,:]) ≈ 41099.40514987405

# inclined lithosphere with only two layers
Temp    =   zeros(Float64, Grid.N...);
Phases  =   zeros(Int64,  Grid.N...);
